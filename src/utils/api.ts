...
export class AuthService {
  ...
  static async verifyOTP(phone_number: string, otp: string, user_name?: string) {
    return axios.post(`${BASE_URL}/auth/phone/verify-otp`, { phone_number, otp, user_name });
  }
  static async login(phone_number: string, otp: string) {
    return axios.post(`${BASE_URL}/auth/phone/login`, { phone_number, otp });
  }
