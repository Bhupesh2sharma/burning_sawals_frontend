            ...
            <main className="min-h-screen bg-pink-50 flex flex-col items-center justify-center font-sans pt-20">
                <div className="text-center">
                    ...
                    <button
                        ...
                        className="px-4 py-2 bg-[#E63946] text-white rounded-md hover:bg-[#A0153A] transition cursor-pointer"
                    >
                        Try Again
                    </button>
                </div>
    ...
    return (
        <main className="min-h-screen bg-pink-50 flex flex-col items-center justify-start font-sans pt-20">
            ...
            <div className="flex flex-col items-center text-center p-6">
                <h2 className="text-xl text-[#000000] mb-4 font-libre-bodoni">
                ...
                <div className="relative flex justify-center items-center mt-2 mb-6">
                    {/* Button */}
                    <Link href="/login">
                        <button className="bg-[#E63946] text-white px-10 py-3 rounded-full font-bold text-lg shadow-md cursor-pointer">
                            Start Playing
                        </button>
                    </Link>
            ...
            <div className="w-full flex flex-col gap-0 my-4">
                {questionTypes.map((questionType, index) => (
                    <Link
                        href={`/questiontype/${questionType.type_id}`}
