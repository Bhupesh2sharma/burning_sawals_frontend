  ...
  return (
    <div className="min-h-screen flex flex-col bg-pink-100">
      ...
      <header className="flex items-center justify-center relative py-4">
        ...
        <h1 className="text-xl font-bold text-black text-center">Friends <span>🧑‍🤝‍🧑</span></h1>
      </header>

      {/* Category Buttons */}
      <div className="flex gap-2 justify-center mb-4 px-2">
        <button className="bg-rose-700 text-white rounded-full px-4 py-2 text-xs font-semibold shadow">Deep thoughts</button>
        <button className="bg-rose-300 text-black rounded-full px-4 py-2 text-xs font-semibold shadow">Calm and Cozy</button>
        <button className="bg-rose-300 text-black rounded-full px-4 py-2 text-xs font-semibold shadow">Controversial</button>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        <div className="relative bg-rose-700 rounded-xl w-full max-w-md mx-auto p-6 flex flex-col items-center min-h-[320px] shadow-lg">
          ...
          <div className="flex w-full justify-between items-center mb-8">
            <span className="text-white text-lg font-semibold flex items-center gap-1">Take a shot and answer <span>🥃</span></span>
            <span className="text-2xl">🌸</span>
          </div>
          {/* Question */}
          <div className="flex-1 flex items-center justify-center w-full">
            <span className="text-white text-center text-xl font-semibold px-2">
              What is that one<br />small thing that<br />makes you really happy?
            </span>
          </div>
          {/* Navigation arrows */}
