      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-pink-100">
        <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md text-center">
          ...
          <button
            ...
            className="px-6 py-2 bg-[#BE1847] text-white rounded-md hover:bg-[#A0153A] transition"
          >
            Submit Another
          </button>
        </div>
      ...
      <div className="max-w-2xl mx-auto px-4">
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <p className="text-gray-600 mb-8">
            We'd love to hear your thoughts! Help us improve BurningSawals by sharing your feedback, suggestions, or reporting any issues.
          </p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              ...
              <div className="flex gap-2">
                {[1, 2, 3, 4, 5].map((value) => (
                  ...
                  >
                    <FiStar size={24} fill={value <= rating ? "currentColor" : "none"} />
                  </button>
                ))}
              </div>
              {rating > 0 && (
            ...
            <div className="flex gap-4">
              <button
                type="submit"
                className="flex-1 bg-[#BE1847] text-white py-3 px-6 rounded-md font-medium hover:bg-[#A0153A] transition focus:outline-none focus:ring-2 focus:ring-[#BE1847] focus:ring-offset-2"
              >
                Submit Feedback
              </button>
              <button
